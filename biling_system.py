...
#=========billArea=================================================
    ...
    def save_bill(self):
        ...
        if op > 0:
            ...
            f1 = open("C:/Users/aramm/Source/Repos/Python-World/python-mini-projects/projects/Billing_system/bills/"+str(self.bill_no.get())+".txt", "w")
    ...
    def find_bill(self):
        present = "no"
        for i in os.listdir("C:/Users/aramm/Source/Repos/Python-World/python-mini-projects/projects/Billing_system/bills/"):
            if i.split('.')[0] == self.search_bill.get():
                f1 = open(f"C:/Users/aramm/Source/Repos/Python-World/python-mini-projects/projects/Billing_system/bills/{i}", "r")
                self.txtarea.delete("1.0", END)
                for d in f1:
